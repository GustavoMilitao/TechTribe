...
<form method="post" action="https://newsletter.militão.eu/subscription/form" class="bg-transparent">
	...
	<div>
		<h3 class="text-lg font-semibold">TechTribe-Newsletter</h3>
		...
		<p class="hidden">
			...
			/>
			<label for="fec55">TechTribe-News</label>
		</p>

...
<footer class="text-center text-white border-black w-screen">
	<div class="grid grid-cols-12 w-full pt-4 bg-gray-700 pb-2">
		<p class="col-start-3 col-end-11 text-center w-full">
			{@html $t('footer.self_ads', {
				militão_link:
					'<a href="https://militão.eu?utm_source=TechTribe&utm_medium=footer" target="_blank" class="underline text-blue-300 hover:text-blue-500 transition">Militão</a>',
			...
			{@html $t('footer.donate', {
				donate_link: `<a href='https://militão.eu/donate' target='_blank' class='underline text-blue-300 hover:text-blue-500 transition'>${$t(
					'words.donating'
				)}</a>`,
				interpolation: { escapeValue: false }
			})}
			<a
				href="https://militão.eu/donate"
				target="_blank"
	...
	<div class="bg-gray-700">
		<p>
			...
			<a
				href="https://fosstodon.org/@techtribe"
				rel="me"
				class="underline text-blue-300 hover:text-blue-500 transition"
				>@techtribe@fosstodon.org</a
			> for updates!
		</p>
	</div>
</footer>

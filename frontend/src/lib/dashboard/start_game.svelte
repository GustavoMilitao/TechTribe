			...
			<label for="cqc-toggle" class="inline-flex relative items-center cursor-pointer">
				...
				<span class="ml-3 text-sm font-medium text-gray-900"
					><a
						...
						use:tippy={{
							content:
								'TechTribeControllers are small physical devices to play TechTribe. Click to learn more.'
						}}
						class="decoration-dashed underline cursor-help">TechTribeControllers</a
					>

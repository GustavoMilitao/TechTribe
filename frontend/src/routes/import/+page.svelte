				...
				<div class="grid grid-cols-2">
					...
					<form on:submit|preventDefault={file_submit}>
						<div class="w-full mt-4 border-l-2 border-gray-600 h-full flex flex-col">
							<h2 class="text-center text-2xl">{$t('import_page.techtribe_quiz')}</h2>
							<div class="dark:bg-gray-800 bg-white p-4 rounded-lg">
								<div class="relative bg-inherit w-full">
									<input
										id="file"
								...
								<p class="mt-2">
									{$t('import_page.this_side_techtribe')}
									<br />
									{$t('import_page.this_side_techtribe_excel')}
								</p>
								<a
									class="text-sm underline font-bold text-blue-500 dark:text-blue-400"
									download
									href="https://ncs3.techtribe.de/blog/techtribe/TechTribeImportTemplate.xlsx"

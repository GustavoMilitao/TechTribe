...
<svelte:head>
	<title>TechTribe/docs - PoW</title>
	<meta
		name="description"
		content="Use-case of PoW for TechTribe, the open-source quiz-application"
	/>
</svelte:head>
<article
...
>
	...
	<p>
		...
		using your CPU. It's mainly used in crypto-stuff, but not in TechTribe. It's just used to

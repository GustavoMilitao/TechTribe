...
<svelte:head>
	<title>TechTribe/docs - Attribution</title>
	<meta name="description" content="People who helped making with TechTribe." />
</svelte:head>
<article
...
>
	...
	<h2>Translators</h2>
	<p>
		People who translated TechTribe on <a href="https://translate.militão.eu/engage/techtribe/"
			>Weblate</a
		> or directly.
	</p>
	<ul>
	...
	<h1>Rules</h1>
	<p>
		If you are listed once here, you're a part of TechTribe, forever! <br />

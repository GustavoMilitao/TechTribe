...
<svelte:head>
	<title>TechTribe/docs - Terms of Service</title>
	<meta
		name="description"
		content="The terms of service of TechTribe, the open-source quiz-application"
	/>
</svelte:head>
...
>
	...
	<h2>What doesn't belong on TechTribe</h2>
	<p>
	...
	<p>You have to report illegal content by writing an email to report@militão.eu</p>
	...
	<p>
		...
		rule or not. TechTribe also doesn't provide any (uptime)-guarantee, so TechTribe could be shut
	...
	<p>
		...
		deleteme@militão.eu. Please include the email you registered with on TechTribe, and, if
		possible, a prove that you are the owner of the account, by, eg., writing the email with the
		email-address which is associated with your TechTribe-account.
	</p>
	...
	<p>
		...
		still got any questions, please contact me at <a href="https://militão.eu/contact"
			>militão.eu/contact</a
		>
	</p>
</article>

...
<svelte:head>
	<title>TechTribe/docs - Import from Kahoot</title>
	<meta
		name="description"
...
>
	<h1>Import Quizzes from Kahoot into TechTribe</h1>
	...
	<p>
		...
		go to
		<a href="https://techtribe.de/import" rel="nofollow" target="_blank">techtribe.de/import</a>

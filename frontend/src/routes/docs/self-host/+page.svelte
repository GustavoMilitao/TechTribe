...
<svelte:head>
	<title>TechTribe/docs - Self-Host</title>
	<meta
		name="description"
		content="How to self-host TechTribe, the open-source quiz-application"
	/>
</svelte:head>
<article
...
>
	<h1>Self-Hosting</h1>
	<p>Since TechTribe is open-source, it can also be self-hosted.</p>
	...
	<pre><code class="language-bash"
			>git clone https://github.com/militão-myblock/techtribe && cd TechTribe</code
		></pre>
	<p>
	...
	<p>
		...
		be scaled and the media doesn't have to streamed through the (comparatively) slow TechTribe
	...
	<p>
		...
		JavaScript origin", which is just the base-domain (with https) of your TechTribe-installation.
	...
	<p><b>TechTribe needs HTTPS/SSL to work properly!</b></p>
	<p><b>Enjoy! ❤️</b></p>
</article>

...
<svelte:head>
	<title>TechTribe - Settings</title>
</svelte:head>
	...
	<div class="w-full grid grid-cols-6">
		<div>
			...
			<div class="m-2 flex justify-center">
				<GreenButton href="/account/settings/avatar"
					>{$t('settings_page.change_avatar')}</GreenButton
				>
			</div>
		</div>
		<div class="grid grid-rows-2 col-start-2 col-end-7">
			<div class="grid grid-cols-2">
				...
				<div class="p-4 flex justify-center">
					<div class="m-auto">
						<GreenButton href="/account/settings/security"
							>{$t('settings_page.security_settings')}
						</GreenButton>
						<GreenButton href="/account/controllers">TechTribeController</GreenButton>
						<GreenButton href="/user/{user.id}">Public profile page</GreenButton>
					</div>
				</div>
			</div>
			<div>
				<form class="flex flex-col md:flex-row" on:submit|preventDefault={changePassword}>
					...
					>
					<div class="my-auto">
						<GreenButton disabled={!passwordChangeDataValid} type="submit">
				...
				<div>
					<div class="w-fit">
						<GreenButton on:click={add_api_key}
							>{$t('settings_page.add_api_key')}</GreenButton
						>
					</div>
					{#await api_keys}
						<Spinner />

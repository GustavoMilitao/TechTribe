...
from techtribe.db.models import User, UserAuthTypes
from techtribe.auth import check_token
from techtribe.helpers.avatar import gzipped_user_avatar
from techtribe.oauth.authenticate_user import log_user_in, rememberme_check
from techtribe.oauth.init_oauth import init_oauth

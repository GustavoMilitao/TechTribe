...
from techtribe.helpers import generate_spreadsheet, handle_import_from_excel
...
async def export_quiz_answers(export_token: str, game_pin: str):
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f"attachment;filename=TechTribe-{urllib.parse.quote(quiz.title)}-{datetime.now().strftime('%m-%d-%Y')}.xlsx"  # noqa: E501
        },
    )

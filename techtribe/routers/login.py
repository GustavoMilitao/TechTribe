...
from techtribe.auth import verify_password
from techtribe.config import redis, settings

from techtribe.db.models import User, FidoCredentials
...
from techtribe.oauth.authenticate_user import log_user_in

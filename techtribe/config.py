...
from techtribe.storage import Storage
...
class Settings(BaseSettings):
    ...
    db_url: str | PostgresDsn = "postgresql://postgres:mysecretpassword@localhost:5432/techtribe"
    ...
    meilisearch_index: str = "techtribe"

...
from techtribe.config import redis, storage
from tempfile import SpooledTemporaryFile

from techtribe.db.models import StorageItem, Quiz, User
from techtribe.helpers import extract_image_ids_from_quiz
